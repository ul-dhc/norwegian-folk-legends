...
const JOURNEY_FLIGHT_CAPTIONS = {
  collector: [
    ...
    'Moving through the legend collection…',
  ...
  legend: [
    ...
    'Preparing to read the next recorded telling…',
  ],
  jump: [
    ...
    'Leaving the current cluster behind…',
...
const JOURNEY_COLLECTOR_PHRASES = [
  ...
  'We come to {name}\u2019s collection – {count} accounts carried to nowadays. Explore one of them…',
  'Somewhere along the way, {name} gathered {count} legends – enough to leave a trace across the map. Let\u2019s find one of them…',
  'Behind {name} are {count} legends, each carrying a place, a voice, and something once believed. One of them reads as following… ',
];
...
const JOURNEY_PLACE_PHRASES = [
  ...
  'Here is {place}, where {count} legend{s} were told, remembered, and written down. Each is special, including this one… ',
  'We stop in {place}. {count} legend{s} were recorded here. Follow me in reading one of them… ',
  'Next is {place}, with {count} legend{s} connected to it. Hear this out… ',
];

const JOURNEY_PLACE_SINGULAR_PHRASES = [
  'We arrive in {place}, where a single legend was recorded. Let us hear it…',
  'The thread settles in {place} – just one legend was recorded here. Must be special. Let\u2019s explore it… ',
  'Here is {place}, home to a single recorded legend. It reads like this… ',
  'We stop in {place}. Only one legend was recorded here. Indeed special. Let\u2019s explore it… ',
